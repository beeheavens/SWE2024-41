...
void sending_handler(int sig) {
  // TODO: code starts
	if(num_ack_received == num_signal_to_send){
...
int main(int argc, char* argv[]) {
  if (argc != 2) { //If no input command line argument.
  ...
  if (num_signal_to_send <= 0) { // Invalid command line argument.
